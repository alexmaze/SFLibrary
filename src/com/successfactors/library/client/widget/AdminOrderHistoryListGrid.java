...
public class AdminOrderHistoryListGrid extends ListGrid {
	...
	public AdminOrderHistoryListGrid(Refreshable jumpbar) {
		super();
		jumpBar = jumpbar;
		
		GWT.log("初始化: AdminOrderHistoryListGrid");
	...
	private void bind() {
		this.addCellDoubleClickHandler(new CellDoubleClickHandler() {
			...
			public void onCellDoubleClick(CellDoubleClickEvent event) {
				OrderDisplayWindow orderDisplayWindow = new OrderDisplayWindow(getSelectedRecord());
