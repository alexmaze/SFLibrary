...
public class AdminBorrowManagementListGrid extends ListGrid implements BorrowEditWindow.FinishEditBorrow{
	...
	public void doRefreshPage() {
		...
		new RPCCall<BorrowPage>() {
			...
			@Override
			protected void callService(AsyncCallback<BorrowPage> cb) {
				borrowService.getBorrowList(BorrowStatusType.NOW, null, DEFAULT_RECORDS_EACH_PAGE, pageNowNum, cb);
			}
		}.retry(3);
		
	}
	
	private AdminBorrowManagementListGrid getSelf() {
		return this;
	}
}
